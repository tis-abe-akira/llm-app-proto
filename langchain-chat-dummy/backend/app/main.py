"""FastAPI application for dummy chat service.

This module provides REST API endpoints for streaming dummy chat interactions
without LLM dependencies, using fixed responses with conversation memory support.
"""
...
async def root():
    ...
    """
    return {"message": "LangChain Chat Dummy API is running"}
